...
//Load images.c file containing images as array
#include "images.h"
      ...
      while(client.connected())
      {
        ...
        {          
          if(StrContains(req, "GET / "))
          {
            ...
            // client.println("\">");
            //client.print("</head> <body><img src=\"test.jpg\"></body></html>");
            client.print("</head> <body></body></html>");
          }
          else if(StrContains(req, "GET /favicon.ico "))
          {
            client.println("HTTP/1.1 200 OK");
            client.println();
